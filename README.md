...
PdZn/ZrO<sub>2</sub> + SAPO-34 tandem catalyst. The modeled reactor is assumed to be a steady-state, one-dimensional, isothermal packed-bed reactor with negligible pressure drop.
